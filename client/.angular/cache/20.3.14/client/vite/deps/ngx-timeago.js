...
_TimeagoDefaultClock.ɵfac = function TimeagoDefaultClock_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TimeagoDefaultClock)(ɵɵinject(PLATFORM_ID));
};
...
var _TimeagoDirective = class _TimeagoDirective {
  ...
  constructor(intl, formatter, element, cd, clock, ngZone) {
    this.cd = cd;
    this.clock = clock;
    this.ngZone = ngZone;
...
_TimeagoDirective.ɵfac = function TimeagoDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TimeagoDirective)(ɵɵdirectiveInject(TimeagoIntl, 8), ɵɵdirectiveInject(TimeagoFormatter), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(TimeagoClock), ɵɵdirectiveInject(NgZone));
};
...
var _TimeagoPipe = class _TimeagoPipe {
  constructor(intl, cd, formatter, clock, ngZone) {
    this.clock = clock;
    this.ngZone = ngZone;
    this.live = true;
    this.stateChanges = new Subject();
...
_TimeagoPipe.ɵfac = function TimeagoPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TimeagoPipe)(ɵɵdirectiveInject(TimeagoIntl, 24), ɵɵdirectiveInject(ChangeDetectorRef, 16), ɵɵdirectiveInject(TimeagoFormatter, 16), ɵɵdirectiveInject(TimeagoClock, 16), ɵɵdirectiveInject(NgZone, 16));
};
...
function provideTimeago(config = {}) {
  const providers = [config.clock || {
    provide: TimeagoClock,
    useClass: TimeagoDefaultClock
  }, config.formatter || {
    provide: TimeagoFormatter,
